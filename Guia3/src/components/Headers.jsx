...
export const Headers=({
    ...
    const onDelateProducts = product =>{
                ...
                {allProducts.length ? (
                    ...
                    <div className='row-product'>
                        ...
                        <div className="cart-product"key={product.id}>
                            ...
                            <img src="https://static.vecteezy.com/system/resources/previews/018/887/462/original/s
igns-close-icon-png.png" alt="cerrar" className="icon-close"onClick={() => onDelateProducts(product)} />
